...
# %% auto 0
__all__ = ['HEADER_URLS', 'tailwind_theme', 'daisy_styles', 'scrollspy_style', 'fast_app', 'FastHTML', 'ThemeRadii',
...
# %% ../nbs/01_core.ipynb
# Tailwind v4 theme definitions using @theme directive
tailwind_theme = fh.Style("""
@theme {
...
class Theme(Enum):
    ...
    def _create_headers(self, urls, mode='auto', icons=True, daisy=True, highlightjs=False, katex=False, apex_charts=False, radii=ThemeRadii.sm, shadows=ThemeShadows.sm, font=ThemeFont.sm):
        ...
        # Tailwind v4 browser script and theme definitions
        hdrs += [
            tailwind_theme,  # Tailwind v4 @theme block
