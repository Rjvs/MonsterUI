...
# %% auto 0
__all__ = ['BUILT_HEADERS', 'HEADER_URLS', 'daisy_styles', 'tailwind_theme_styles', 'scrollspy_style', 'fast_app', 'FastHTML',
           'ThemeRadii', 'ThemeShadows', 'ThemeFont', 'Theme']
...
def fast_app(*args, pico=False, **kwargs):
    ...
    if 'htmlkw' not in kwargs: kwargs['htmlkw'] = {}
    if 'data-theme' not in kwargs['htmlkw']: kwargs['htmlkw']['data-theme'] = ''
    kwargs['htmlkw']['data-theme'] = stringify((kwargs['htmlkw']['data-theme'],'blue'))
    if 'data-mode' not in kwargs['htmlkw']: kwargs['htmlkw']['data-mode'] = ''
    kwargs['htmlkw']['data-mode'] = stringify((kwargs['htmlkw']['data-mode'],'dark'))
    # if 'data-daisy-root' not in kwargs['htmlkw']: kwargs['htmlkw']['data-daisy-root'] = True
...
# %% ../nbs/01_core.ipynb
BUILT_HEADERS = {
        'monster_css': "./vite/outputs/monsterui.css",
        'themes_css': "./vite/themes.css",
        'franken_js': "./vite/outputs/monsterui-core.js",
        'franken_icons': "./vite/outputs/monsterui-icons.js",
        'franken_rte': "./vite/outputs/monsterui-rte.js",
...
class Theme(Enum):
    ...
    def _create_built_headers(self, urls, mode='auto', icons=True, rte=False, highlightjs=False, katex=False, apex_charts=False, radii=ThemeRadii.sm, shadows=ThemeShadows.sm, font=ThemeFont.sm):
        "Create header elements using Vite-built assets"
        hdrs = [
            fh.Script(type="module", src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4"),
            fh.Link(rel="stylesheet", href=urls['monster_css']),
            fh.Link(rel="stylesheet", href=urls['themes_css']),
            fh.Script(type="module", src="https://cdn.jsdelivr.net/npm/franken-ui@2.1.1/dist/js/core.iife.js"),
            tailwind_theme_styles,
            _headers_theme(self.value, mode=mode, radii=radii, shadows=shadows, font=font),
            scrollspy_style,
        ]

        if icons: hdrs.append(fh.Script(type="module", src="https://cdn.jsdelivr.net/npm/franken-ui@2.1.1/dist/js/icon.iife.js"))
        if rte: hdrs.append(fh.Script(type="module", src="urls['franken_rte']"))
        if apex_charts: hdrs += [fh.Script(type='module', src=urls['apex_charts'])]
    ...
    def built_headers(self, mode='auto', icons=True, rte=False, highlightjs=False, katex=False, apex_charts=False, radii=ThemeRadii.sm, shadows=ThemeShadows.sm, font=ThemeFont.sm):
        "Create headers using Vite-built assets (Tailwind 4 + FrankenUI 2.1.1 + DaisyUI 5)"
        return self._create_built_headers(BUILT_HEADERS, mode=mode, icons=icons, rte=rte, highlightjs=highlightjs, katex=katex, apex_charts=apex_charts, radii=radii, shadows=shadows, font=font)
